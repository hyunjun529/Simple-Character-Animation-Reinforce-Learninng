...
struct EnviromentTest : public CommonRigidBodyBase
{
	...
	void initState(EnviromentTest* target) {
...
void EnviromentTest::lockLiftHinge(btHingeConstraint* hinge)
{
...
void EnviromentTest::initPhysics()
{
	int upAxis = 1;
...
bool EnviromentTest::keyboardCallback(int key, int state)
{
	bool handled = true;
	if (state)
	{
