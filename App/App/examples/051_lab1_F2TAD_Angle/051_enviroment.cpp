...
struct lab1Example1 : public CommonRigidBodyBase
{
...
lab1Example1::lab1Example1(struct GUIHelperInterface* helper)
...
void lab1Example1::lockLiftHinge(btHingeConstraint* hinge)
{
...
bool lab1Example1::keyboardCallback(int key, int state)
{
	bool handled = true;
	if (state)
	{
...
CommonExampleInterface*    env_051(CommonExampleOptions& options)
{
	return new lab1Example1(options.m_guiHelper);
}