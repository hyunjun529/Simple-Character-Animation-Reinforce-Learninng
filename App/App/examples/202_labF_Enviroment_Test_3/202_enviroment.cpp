...
struct LabF202 : public CommonRigidBodyBase
{
	...
	LabF202(struct GUIHelperInterface* helper);
	virtual ~LabF202();
...
LabF202::LabF202(struct GUIHelperInterface* helper)
...
void LabF202::lockLiftHinge(btHingeConstraint* hinge)
{
...
void LabF202::stepSimulation(float deltaTime)
{
...
bool LabF202::keyboardCallback(int key, int state)
{
	bool handled = true;
	if (state)
	{
...
CommonExampleInterface*    env_202(CommonExampleOptions& options)
{
	return new LabF202(options.m_guiHelper);
}