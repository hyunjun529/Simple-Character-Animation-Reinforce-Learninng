...
struct LabF201 : public CommonRigidBodyBase
{
	...
	LabF201(struct GUIHelperInterface* helper);
	virtual ~LabF201();
...
LabF201::LabF201(struct GUIHelperInterface* helper)
...
void LabF201::lockLiftHinge(btHingeConstraint* hinge)
{
...
void LabF201::stepSimulation(float deltaTime)
{
...
bool LabF201::keyboardCallback(int key, int state)
{
	bool handled = true;
	if (state)
	{
...
CommonExampleInterface*    env_201(CommonExampleOptions& options)
{
	return new LabF201(options.m_guiHelper);
}